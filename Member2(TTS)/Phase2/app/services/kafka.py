...
class KafkaService:
    """Kafka service for TTS event streaming"""
    ...
    def produce_generation_completed(self, job_id: str, audio_path: str, status: str = "completed"):
        """
        Produce audio.generation.completed event.
        
        Args:
            job_id: The TTS job ID
            audio_path: Path/URL to the generated audio
            status: Job status
        """
        self.produce_event("audio.generation.completed", {
            "job_id": job_id,
